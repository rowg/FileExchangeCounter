...
The Bash scripts contained in the FileExchangeCounter repository parse the FileExchange logs and "boils them down" into summaries of the number of files of each type transferred in a given day. 
